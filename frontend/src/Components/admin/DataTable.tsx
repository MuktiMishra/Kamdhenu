  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      {mode === "specificView" && selectedCandidate && (
        <DetailedSpecificData placementSupport={selectedCandidate.placementSupport} educationSupport={selectedCandidate.educationSupport} trainingSupport={selectedCandidate.trainingSupport} closePopup={() => setSelectedCandidate(null)}/>
      )}
    </div>
  );
};

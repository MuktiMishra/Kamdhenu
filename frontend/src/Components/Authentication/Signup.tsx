        ...
        <div className='grid grid-cols-1 md:grid-cols-2 justify-center items-center'>
            ...
            <div className='flex flex-col w-80 md:w-96 justify-center items-center gap-4 shadow-md rounded-md m-4'>
                ...
                <div className='flex gap-1'>
                    <input type="text" className="w-36 lg:w-40 h-7 text-center rounded-md bg-slate-200" placeholder="First Name" value={formData.firstName} onChange={handleChange} />
                    <input type="text" className="w-36 lg:w-40 h-7 text-center rounded-md bg-slate-200" placeholder="Last Name" value={formData.lastName} onChange={handleChange} />
                </div>
                ...
                <input type="text" className="w-72 lg:w-80 h-7 rounded-md bg-slate-200" placeholder="Email" value={formData.emailId} onChange={handleChange} />
                ...
                <input type="password" className="w-72 lg:w-80 h-7 rounded-md bg-slate-200" placeholder="Confirm Password" value={formData.confirmPassword} onChange={handleChange} />
